...
using eShop.OrdersMicroservie.DataAccessLayer.Repositories;
...
public class OrdersService(
  ...
  IMapper _mapper,
  IValidator<OrderAddRequest> _orderAddRequestValidator,
  IValidator<OrderItemAddRequest> _orderItemAddRequestValidator,
  IValidator<OrderUpdateRequest> _orderUpdateRequestValidator,
  IValidator<OrderItemUpdateRequest> _orderItemUpdateRequestValidator,
  UsersMicroserviceClient _usersMicroserviceClient,
  ProductsMicroserviceClient _productsMicroserviceClient) : IOrdersService
  {
